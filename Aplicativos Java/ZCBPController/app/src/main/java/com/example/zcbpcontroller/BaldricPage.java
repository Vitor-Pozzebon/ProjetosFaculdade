...
public class BaldricPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baldric_page);
    ...
    public void somarUm(View view) {
        ...
        if(numeroAtual == 19){
            ...
            final String[] opcoes = getResources().getStringArray(R.array.LaranjaBaldric);
            msgOrangeList.setItems(R.array.LaranjaBaldric, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    // The 'which' argument contains the index position
                    // of the selected item
                    String escolha = opcoes[which];
                    if(escolha.contains("+1 Ação de Magia Grátis")){
                        CheckBox cbl1 = findViewById(R.id.checkBoxLaranja1);
                    ...
                    Toast.makeText(BaldricPage.this, "Opção escolhida: " + escolha, Toast.LENGTH_SHORT).show();
                }
            });
            msgOrangeList.show();
        }
        ...
        if(numeroAtual == 43){
            ...
            final String[] opcoes = getResources().getStringArray(R.array.VermelhoBaldric);
            msgRedList.setItems(R.array.VermelhoBaldric, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    // The 'which' argument contains the index position
                    // of the selected item
                    String escolha = opcoes[which];
                    if(escolha.contains("+1 Dado: Mágica")){
                        CheckBox cbv1 = findViewById(R.id.checkBoxVermelho1);
    ...
    public void exibirConfirmacao1(View v){
        ...
        msgbox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                validar2();
                Toast.makeText(BaldricPage.this, "Dano Sofrido. Cuidado!", Toast.LENGTH_LONG).show();
            }
        });
        msgbox.setNegativeButton("Não", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(BaldricPage.this, "Operação Cancelada", Toast.LENGTH_LONG).show();
            }
        });
        msgbox.show();
    }
    ...
    public void exibirConfirmacao3(View v){
        ...
        msgbox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                validar4();
                dialogBoxdeath();
                Toast.makeText(BaldricPage.this, "Morte do Personagem", Toast.LENGTH_LONG).show();
