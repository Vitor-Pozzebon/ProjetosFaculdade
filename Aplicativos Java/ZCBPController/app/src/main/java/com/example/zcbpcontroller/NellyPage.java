...
public class NellyPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nelly_page);
    ...
    public void somarUm(View view) {
        ...
        if(numeroAtual == 19){
            ...
            final String[] opcoes = getResources().getStringArray(R.array.LaranjaNelly);
            msgOrangeList.setItems(R.array.LaranjaNelly, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    // The 'which' argument contains the index position
                    // of the selected item
                    String escolha = opcoes[which];
                    if(escolha.contains("Sede de Sangue: Corpo a Corpo")){
                        CheckBox cbl1 = findViewById(R.id.checkBoxLaranja1);
                    ...
                    Toast.makeText(NellyPage.this, "Opção escolhida: " + escolha, Toast.LENGTH_SHORT).show();
                }
            });
            msgOrangeList.show();
        }
        ...
        if(numeroAtual == 43){
            ...
            final String[] opcoes = getResources().getStringArray(R.array.VermelhoNelly);
            msgRedList.setItems(R.array.VermelhoNelly, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    // The 'which' argument contains the index position
                    // of the selected item
                    String escolha = opcoes[which];
    ...
    public void exibirConfirmacao1(View v){
        ...
        msgbox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                validar2();
                Toast.makeText(NellyPage.this, "Dano Sofrido. Cuidado!", Toast.LENGTH_LONG).show();
            }
        });
        msgbox.setNegativeButton("Não", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(NellyPage.this, "Operação Cancelada", Toast.LENGTH_LONG).show();
            }
        });
        msgbox.show();
    }
    ...
    public void exibirConfirmacao3(View v){
        ...
        msgbox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                validar4();
                dialogBoxdeath();
                Toast.makeText(NellyPage.this, "Morte do Personagem", Toast.LENGTH_LONG).show();
