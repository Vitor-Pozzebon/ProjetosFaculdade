...
public class SamsonPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_samson_page);
    ...
    public void somarUm(View view) {
        ...
        if(numeroAtual == 19){
            ...
            final String[] opcoes = getResources().getStringArray(R.array.LaranjaSamson);
            msgOrangeList.setItems(R.array.LaranjaSamson, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Toast.makeText(SamsonPage.this, "Opção escolhida: " + escolha, Toast.LENGTH_SHORT).show();
                }
            });
            msgOrangeList.show();
        }
        ...
        if(numeroAtual == 43){
            ...
            final String[] opcoes = getResources().getStringArray(R.array.VermelhoSamson);
            msgRedList.setItems(R.array.VermelhoSamson, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    // The 'which' argument contains the index position
                    // of the selected item
                    String escolha = opcoes[which];
    ...
    public void exibirConfirmacao1(View v){
        ...
        msgbox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                validar2();
                Toast.makeText(SamsonPage.this, "Dano Sofrido. Cuidado!", Toast.LENGTH_LONG).show();
            }
        });
        msgbox.setNegativeButton("Não", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(SamsonPage.this, "Operação Cancelada", Toast.LENGTH_LONG).show();
            }
        });
        msgbox.show();
    }
    ...
    public void exibirConfirmacao3(View v){
        ...
        msgbox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                validar4();
                dialogBoxdeath();
                Toast.makeText(SamsonPage.this, "Morte do Personagem", Toast.LENGTH_LONG).show();
