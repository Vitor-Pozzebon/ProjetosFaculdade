...
import static com.example.zcbpcontroller.R.*;
...
public class SilasPage extends AppCompatActivity {

    public TextView textViewNivel;
    public int numeroAtual;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(layout.activity_silas_page);

        textViewNivel = findViewById(id.textViewLevel);
        numeroAtual = 0; // Defina o valor inicial do número

        // Atualize o TextView com o valor inicial
        textViewNivel.setText(String.valueOf(numeroAtual));
        textViewNivel = findViewById(id.textViewLevel);
        numeroAtual = 0; // Defina o valor inicial do número
        ...
        CheckBox cba = findViewById(id.checkBoxAmarelo);
        CheckBox cbl1 = findViewById(id.checkBoxLaranja1);
        CheckBox cbl2 = findViewById(id.checkBoxLaranja2);
        CheckBox cbv1 = findViewById(id.checkBoxVermelho1);
        CheckBox cbv2 = findViewById(id.checkBoxVermelho2);
        CheckBox cbv3 = findViewById(id.checkBoxVermelho3);
        ...
        CheckBox cbLife0 = findViewById(id.checkBoxLife0);
        CheckBox cbLife2 = findViewById(id.checkBoxLife2);
        CheckBox cbLife3 = findViewById(id.checkBoxLife3);
    ...
    public void somarUm(View view) {
        ...
        if(numeroAtual == 19){
            ...
            final String[] opcoes = getResources().getStringArray(array.LaranjaSilas);
            msgOrangeList.setItems(R.array.LaranjaSilas, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    // The 'which' argument contains the index position
                    // of the selected item
                    String escolha = opcoes[which];
                    if(escolha.contains("+1 Ação de Alcance Grátis")){
                    ...
                    Toast.makeText(SilasPage.this, "Opção escolhida: " + escolha, Toast.LENGTH_SHORT).show();
                }
            });
            msgOrangeList.show();
        }
        ...
        if(numeroAtual == 43){
            ...
            final String[] opcoes = getResources().getStringArray(array.VermelhoSilas);
            msgRedList.setItems(R.array.VermelhoSilas, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    // The 'which' argument contains the index position
                    // of the selected item
                    String escolha = opcoes[which];
                    if(escolha.contains("+1 Dado: Alcance")){
    ...
    public void subtUm(View view) {
        ...
        // Atualizar o TextView com o novo valor
        textViewNivel
                .setText(String.valueOf(numeroAtual));

        //======================================================================================================================
        //ao sair do amarelo
        if(numeroAtual < 7){
            CheckBox cbAmarelo = findViewById(id.checkBoxAmarelo);
    ...
    public void exibirConfirmacao1(View v){
        ...
        msgbox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                validar2();
                Toast.makeText(SilasPage.this, "Dano Sofrido. Cuidado!", Toast.LENGTH_LONG).show();
            }
        });
        msgbox.setNegativeButton("Não", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(SilasPage.this, "Operação Cancelada", Toast.LENGTH_LONG).show();
            }
        });
        msgbox.show();
    }
    ...
    public void exibirConfirmacao3(View v){
        ...
        msgbox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                validar4();
                dialogBoxdeath();
                Toast.makeText(SilasPage.this, "Morte do Personagem", Toast.LENGTH_LONG).show();
