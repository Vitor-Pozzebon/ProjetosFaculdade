...
public class AnnPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ann_page);
    ...
    public void somarUm(View view) {
        ...
        if(numeroAtual == 19){
            ...
            final String[] opcoes = getResources().getStringArray(R.array.LaranjaAnn);
            msgOrangeList.setItems(R.array.LaranjaAnn, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Toast.makeText(AnnPage.this, "Opção escolhida: " + escolha, Toast.LENGTH_SHORT).show();
                }
            });
            msgOrangeList.show();
        }
        ...
        if(numeroAtual == 43){
            ...
            final String[] opcoes = getResources().getStringArray(R.array.VermelhoSilas);
    ...
    public void exibirConfirmacao1(View v){
        ...
        msgbox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                validar2();
                Toast.makeText(AnnPage.this, "Dano Sofrido. Cuidado!", Toast.LENGTH_LONG).show();
            }
        });
        msgbox.setNegativeButton("Não", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(AnnPage.this, "Operação Cancelada", Toast.LENGTH_LONG).show();
            }
        });
        msgbox.show();
    }
    ...
    public void exibirConfirmacao3(View v){
        ...
        msgbox.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                validar4();
                dialogBoxdeath();
                Toast.makeText(AnnPage.this, "Morte do Personagem", Toast.LENGTH_LONG).show();
